...
function fillspEventsArray(data) {
    ...
    console.log("special events Array:", specialEventsArray);
...
specialEventsObject.loadspecialEventsArray = () => {
    ...
    return new Promise(function(resolve, reject) {
        ...
        spEventsLoader.open("GET", `https://theme-park-cfa10.firebaseio.com/attractions.json?orderBy="type_id"&equalTo=8`);
        spEventsLoader.send();
